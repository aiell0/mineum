...
function Settings() {
  return (
    <div className="subscribe section bg-dark py-4">
      <h3 className="section-title text-center text-white m-5"><i className="fas fa-cogs" style={{color: '#8c8c8c8c'}} ></i> Settings</h3>
      <Form>
        <FormGroup></FormGroup>
      </Form>
      <Container>
              ...
              <Col md={'12'} lg={'4'}>
                <Card className="mb-4">
                  <CardBody>
                    ...
                    <CardText><i className="fas fa-arrow-circle-up"></i> Automatically start mining time when the page is loaded.</CardText>
              ...
              <Col md={'12'} lg={'4'}>
                <Card className="mb-4">
                  <CardBody>
                    ...
                    <CardText><i className="fas fa-arrow-circle-up"></i> Receive status and maintenance messages.</CardText>
              ...
              <Col md={'12'} lg={'4'}>
                <Card className="mb-4">
                  <CardBody>
                    ...
                    <CardText><i className="fas fa-gavel"></i> Some text about the setting. to explain its function.</CardText>
                    <a className="btn btn-outline-success btn-normal" href="" target="_blank">ON →</a>  <button type="button" className="btn btn-outline-warning">OFF</button>
                  </CardBody>
                </Card>
              </Col>
            </CardDeck>
